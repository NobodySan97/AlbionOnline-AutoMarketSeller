...
STRINGS = {
    "en": {
        ...
        "tab_settings": "⚙️ Global Settings",
        "banner_mode_fast": "⚡ Instant native -1 Silver undercut (no OCR, 0.6s/item). Clicks Sell -> [-] -> Create.",
        "banner_mode_ocr": "🧠 Smart OCR: reads price from screen, calculates % discount, and types the order.",
        "mode_switched_fast": "Active mode: ⚡ Undercut -1 Silver (Native Fast Mode)",
        "mode_switched_ocr": "Active mode: 🧠 % Discount (Smart OCR Mode)",
        "section_positions": "Click Positions",
        "section_timing_fast": "Fast Cycle Delays (Milliseconds)",
        "section_timing_ocr": "OCR Delays (Milliseconds)",
        ...
        "hud_wizard_title": "🎯 SETUP WIZARD (3 CLICKS)",
        "hud_wizard_step_1": "1/3: Click 'Sell' on the top item in inventory",
        "hud_wizard_step_2": "2/3: Click '[-]' button to decrement price (-1 Silver)",
        "hud_wizard_step_3": "3/3: Click 'Create' sell order button",
        "hud_wizard_complete": "✅ All 3 positions set and saved!",
        "hud_ocr_wizard_title": "🧠 OCR SETUP WIZARD (4 STEPS)",
        "hud_ocr_step_1": "1/4: Click 'Sell' on the top item",
        "hud_ocr_step_box_p1": "2/4: Click TOP-LEFT corner of price area",
        "hud_ocr_step_box_p2": "2/4: Click BOTTOM-RIGHT corner of price area",
        "hud_ocr_step_input": "3/4: Click the price input field",
        "hud_ocr_step_create": "4/4: Click 'Create' order button",
        "hud_ocr_complete": "✅ OCR wizard completed successfully!",
        "hud_capture_title": "🎯 POSITION CAPTURE",
        "hud_capture_instruction": "Click on screen to set: {}",
    },
    "it": {
        "app_title": "Albion Market Assistant",
        "header_title": "ALBION MARKET ASSISTANT",
        ...
        "tab_settings": "⚙️ Impostazioni Globali",
        "banner_mode_fast": "⚡ Undercut nativo istantaneo -1 Silver (senza OCR, 0.6s per oggetto). Clicca Sell -> [-] -> Create.",
        "banner_mode_ocr": "🧠 OCR intelligente: legge il prezzo a schermo, calcola lo sconto in % e digita l'ordine.",
        "mode_switched_fast": "Modalità attiva: ⚡ Undercut -1 Silver (Modalità Veloce Nativa)",
        "mode_switched_ocr": "Modalità attiva: 🧠 Sconto % (Modalità Smart OCR)",
        "section_positions": "Posizioni di Click",
        "section_timing_fast": "Tempi & Ritardi Ciclo Veloce (Millisecondi)",
        "section_timing_ocr": "Tempi & Ritardi OCR (Millisecondi)",
        "btn_wizard": "Setup Wizard (3 Click)",
        "label_pos_a": "Pos A",
        "label_pos_b": "Pos B",
        "label_pos_c": "Pos C",
        ...
        "hud_wizard_title": "🎯 SETUP WIZARD (3 CLICK)",
        "hud_wizard_step_1": "1/3: Fai click su 'Sell' del primo oggetto in inventario",
        "hud_wizard_step_2": "2/3: Fai click sul tasto '[-]' del prezzo (-1 Silver)",
        "hud_wizard_step_3": "3/3: Fai click sul tasto 'Create' ordine di vendita",
        "hud_wizard_complete": "✅ Tutte e 3 le posizioni sono state salvate!",
        "hud_ocr_wizard_title": "🧠 WIZARD SETUP OCR (4 STEP)",
        "hud_ocr_step_1": "1/4: Fai click sul tasto 'Sell' dell'oggetto",
        "hud_ocr_step_box_p1": "2/4: Fai click in ALTO A SINISTRA dell'area prezzo",
        "hud_ocr_step_box_p2": "2/4: Fai click in BASSO A DESTRA dell'area prezzo",
        "hud_ocr_step_input": "3/4: Fai click sul campo input del prezzo",
        "hud_ocr_step_create": "4/4: Fai click sul tasto 'Create' ordine",
        "hud_ocr_complete": "✅ Wizard OCR completato con successo!",
        "hud_capture_title": "🎯 CATTURA POSIZIONE",
        "hud_capture_instruction": "Fai click sullo schermo per impostare: {}",
    },
}
